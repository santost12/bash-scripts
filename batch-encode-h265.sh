...
ffmpegBinary="/c/Users/tyler/bin/ffmpeg-2022-06-06-git-73302aa193-full_build/bin/ffmpeg.exe"
...
ffmpegArguments="-c:v libx265 -crf 28 -pix_fmt yuv420p10le -preset medium -c:a libopus -b:a 128k"
